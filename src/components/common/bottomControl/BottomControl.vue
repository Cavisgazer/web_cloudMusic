  ...
  <div class="bottomControl">
    ...
    <div class="left">
      ...
      <div class="downloadContainer" v-if="musicDetail.name">
        <i class="iconfont icon-xiazai" @click="downloadCurrentMusic"></i>
      </div>
    </div>
    <!-- 中间 -->
    <div class="center">
      <div class="buttons">
        <span><i class="iconfont icon-danquxunhuan"></i></span>
        ...
        <span @click="changePlayState">
          ...
          <i class="iconfont icon-bofangzhong" v-else></i>
        </span>
...
import { getSongsUrl } from "network/songs.js";
let lastSecond = 0;
// 总时长的秒数
let durationNum = 0;
// 保存当前音量
...
export default {
  ...
  methods: {
    ...
    async getMusicDetail(id) {
      ...
      await getSongsUrl(id).then((result) => {
        console.log(result);
        ...
        musicType = result.data[0].type.toLowerCase();
...
.center .icon-danquxunhuan {
  font-size: 17px;
}
.center .icon-shoucang {
  font-size: 15px;
}
